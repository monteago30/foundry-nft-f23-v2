...
deploy:
	@forge script script/DeployMainNft.s.sol:DeployMainNft $(NETWORK_ARGS)

mint:
	@forge script script/Interactions.s.sol:CreateMainNft ${NETWORK_ARGS}

deployMood:
	@forge script script/DeployChangeMoodNft.s.sol:DeployChangeMoodNft $(NETWORK_ARGS)
